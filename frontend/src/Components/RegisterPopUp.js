        ...
        .then((res) => {
          if (res.data === "success" && res.status === 200) {
            ...
            if (localStorage.getItem("cart")) {
              ...
              axios({
                url: `${process.env.REACT_APP_BACKEND_URI}/api/cart/add/items`,
                method: "get",
                params: data,
                withCredentials: true,
                headers: {
            ...
            if (setConfirmEmail && setRegisterPopUp) {
    ...
    >
      ...
      <div className="lg:grid lg:grid-cols-2 relative bg-white rounded-lg w-[95%] sm:w-fit lg:w-[1000px] m-auto lg:py-10">
        ...
        <div className={`relative lg:px-4`}>
          <div className="register-box border-[1px] w-full lg:w-[95%] m-auto sm:w-[450px] bg-gray-50 shadow-[0px_30px_41px_-31px_rgba(0,0,0,0.59)] border-gray-600 rounded-lg h-max p-4 flex flex-col items-center gap-2">
            ...
            <p className="text-red-600 text-xs text-center my-1 w-full">
              {res}
            </p>
            <form
            ...
            >
              ...
              >
                ...
                <div className="flex justify-center gap-2">
                  ...
                  {setLoginPopUp && setRegisterPopUp ? (
                    <button
